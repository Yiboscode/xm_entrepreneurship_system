<template>
  <div class="login-container">
    <div class="login-box">
      <div style="font-weight: bold; font-size: 24px; text-align: center; margin-bottom: 30px; color: #1450aa">创新创业课程考核项目选题系统</div>
      <el-form ref="formRef" :model="data.form" :rules="data.rules">
        ...
        <el-form-item prop="role">
          <el-select size="large" v-model="data.form.role" placeholder="请选择注册角色">
